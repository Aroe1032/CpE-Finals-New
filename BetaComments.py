...
# List of materials and density values in terms of kg/m^3
materialskgm3 = {
    "Aluminum": 2700,
    "Polyethylene": 960,
    "Concrete": 2500,
...
# List of materials and density values in terms of g/cm^3
materialsgcm3 = {
    "Aluminum": 2.70,
    "Polyethylene": 0.96,
    "Concrete": 2.50,
...
def figure_app():
    ...
    def solid_cone(radius, height, density, unit, used_mat, shape, density_unit):
        # Function for calculating and displaying the required mass of a material for a solid cone
    ...
    def solid_cone_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a solid cone
        shape = "Solid Cone"
    ...
    def solid_cube(side_length, density, unit, used_mat, shape, density_unit):
        # Function for calculating and displaying the required mass of a material for a solid cube
    ...
    def solid_cube_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a solid cube
        shape = "Solid Cube"
    ...
    def solid_cylinder(radius, height, density, unit, used_mat, shape, density_unit):
        # Function for calculating and displaying the required mass of a material for a solid cylinder
    ...
    def solid_cylinder_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a solid cylinder
    ...
    def solid_rectangle(length, width, height, density, unit, used_mat, shape, density_unit):
        # Function for calculating and displaying the required mass of a material for a solid rectangular prism
    ...
    def solid_rectangle_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a solid rectangular prism
    ...
    def solid_sphere(radius, density, unit, used_mat, shape, density_unit):
        # Function for calculating and displaying the required mass of a material for a solid sphere
    ...
    def solid_sphere_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a solid sphere
        shape = "Solid Sphere"
    ...
    def solid_triangular_trough(base_length, height, length, density, unit, used_mat, shape, density_unit):
        # Function for calculating and displaying the required mass of a material for a solid triangular trough
    ...
    def solid_triangle_trough_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a solid triangular trough
    ...
    def solid_octahedron(side_length, density, unit, used_mat, shape, density_unit):
        # Function for calculating and displaying the required mass of a material for a solid octahedron
    ...
    def solid_octahedron_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a solid octahedron
    ...
    def solid_ring(height, outer_radius, inner_radius, density, unit, used_mat, shape, density_unit):
        # Function for calculating and displaying the required mass of a material for a solid ring
    ...
    def solid_ring_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a solid ring
        shape = "Ring"
    ...
    def solid_spiral_coil(radius, pitch, length, density, unit, used_mat, shape, density_unit):
        # Function for calculating and displaying the required mass of a material for a solid spiral coil
    ...
    def solid_spiral_coil_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a solid spiral coil
    ...
    def hollow_tube(height, outer_radius, inner_radius, density, unit, used_mat, shape, density_unit):
        # Function for calculating and displaying the required mass of a material for a hollow tube w/ two openings
    ...
    def hollow_tube_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a hollow tube w/ two openings
    ...
    def hollow_hexagonal_strut(outer_side_length, inner_side_length, length, density, unit, used_mat, shape,
                               density_unit):
        # Function for calculating and displaying the required mass of a material for a hollow hexagonal strut
    ...
    def hollow_hexagonal_strut_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass of a material for a hollow hexagonal strut
    ...
    def hollow_trapezoid_trough_with_base_opening(
        ...
        # Function for calculating and displaying the required mass
        # of a material for a hollow trapezoid trough w/ base opening
    ...
    def hollow_trapezoid_trough_with_base_opening_prompt(density, unit, used_mat, density_unit):
        # Function for user prompts and display for the required mass
        # of a material for a hollow trapezoid trough w/ base opening
    ...
    def material_choice(materials, unit):  # Function for material selection
        while True:
            try:
    ...
    def get_mass_unit(unit, mass):  # Function for the conversion factors of the initial results
        if unit == "m":
            mass_unit = "kilograms"
            mass_formatted = mass
        elif unit == "cm":
    ...
    def result_header(used_mat, shape):  # Function for displaying the header for the results
        print("{}\n".format("-".center(100, "-")))
        print("{}\n".format(f"{used_mat} {shape}".center(100)))

    def initial_result(used_mat, mass_formatted):  # Function for displaying the initial result in kilograms
        print(f"Required Mass of {used_mat} (in kg): {mass_formatted:,.8f} kilograms")

    def print_mass_needed(mass_needed, used_mat, shape, unit):  # Function for displaying the final results w/ units
        if unit == "m":
            mass_unit = "kilograms"
    ...
    def user_choice():  # Function for the program restart/exit
